...
def create_model(
    ...
    if version == 'wmh':
        from .wmh_unet import UNetModel_WMH
        return UNetModel_WMH(
    ...
    if version == 'hybrid':
        from .unet import UNetModel_hybrid
        return UNetModel_hybrid(
            image_size=image_size,
            in_channels=in_ch,
            model_channels=num_channels,
            out_channels=1,
...
def create_gaussian_diffusion(
    *,
    ...
    if predict_v:
        model_mean_type = gd.ModelMeanType.V_PREDICTION
    elif predict_xstart:
